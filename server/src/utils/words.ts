export const WORD_BANK: string[] = [
  ...
  "COACH", "COAST", "CODE", "COLD", "COMIC", "COMPOUND", "CONCERT", "CONDUCTOR",
  "CONTRACT", "COOK", "COPPER", "COTTON", "COUCH", "COURT", "COVER", "CRANE",
  "CRASH", "CRICKET", "CROSS", "CROWN", "CYCLE", "CZECH", "DANCE", "DATE",
  "DAY", "DEATH", "DECK", "DEGREE", "DIAMOND", "DICE", "DINOSAUR", "DISEASE",
  "DOCTOR", "DOG", "DRAFT", "DRAGON", "DRESS", "DRILL", "DROP", "DRUM",
  ...
  "FORK", "FRANCE", "FRANK", "FRONT", "GAME", "GAS", "GENIUS", "GERMANY",
  "GHOST", "GIANT", "GLASS", "GLOVE", "GOLD", "GRACE", "GRASS", "GREECE",
  "GREEN", "GROUND", "HAM", "HAND", "HANGER", "HAWK", "HEAD", "HEART",
  "HELICOPTER", "HIMALAYAS", "HOLE", "HOLLYWOOD", "HONEY", "HOOD", "HOOK",
  "HORN", "HORSE", "HORSESHOE", "HOSPITAL", "HOTEL", "ICE", "INDIA", "IRON",
  ...
  "MAPLE", "MARBLE", "MARCH", "MARKET", "MARS", "MASK", "MASS", "MATCH",
  "MERCURY", "MEXICO", "MICROSCOPE", "MILLIONAIRE", "MINE", "MINT", "MISSILE",
  "MODEL", "MOLE", "MOON", "MOSCOW", "MOUNT", "MOUSE", "MOUTH", "MUG",
  "NAIL", "NEEDLE", "NET", "NEW", "NIGHT", "NINJA", "NOTE", "NOVEL", "NURSE",
  "NUT", "OCTOPUS", "OIL", "OLIVE", "OLYMPUS", "OPERA", "ORANGE", "ORGAN",
  ...
  "POST", "POUND", "PRESS", "PRINCE", "PRINCESS", "PUMPKIN", "PUPIL", "PYRAMID",
  ...
  "SEAL", "SERVER", "SHADOW", "SHAKESPEARE", "SHARK", "SHED", "SHELL", "SHIP",
  ...
  "THUMB", "TICK", "TIE", "TIME", "TOKYO", "TOOTH", "TOWER", "TRACK", "TRAIN",
